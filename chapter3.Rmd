...
Damn, I went totally wrong here, since according to the figure above male students are consuming significantly more alcohol than female students on average. Let's then explore if weekly study time matters on alcohol use:
